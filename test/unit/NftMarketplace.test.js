...
!developmentChains.includes(network.name)
    ...
    : describe("Nft Marketplace Tests", function () {
          ...
          describe("listItem", function () {
              ...
              it("exclusive items that have not been listed", async function () {
          ...
          describe("updateListing", function () {
              ...
              it("reverts if the new price is zero", async function () {
                  const updatedPrice = await ethers.utils.parseEther("0")
                  await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
                  await expect(
              ...
              it("updates the price of the nft", async function () {
                  await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
                  const updatedPrice = await ethers.utils.parseEther("0.2")
                  expect(
                  await nftMarketplace
                      .updateListing(basicNft.address, TOKEN_ID, updatedPrice))
                      .to.emit("ItemListed")
                  const listing = await nftMarketplace.getListing(basicNft.address, TOKEN_ID)
